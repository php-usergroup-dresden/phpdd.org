...
<div class="speaker">
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-8">
			...
			<p>
				<a href="@baseUrl@/de/programm.html#phive" class="text-uppercase"><b>Talk:</b> PhiVE - Managing your PHP toolchain</a>
			</p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
			<a href="@baseUrl@/assets/images/speakers/Arne_Blankerts.jpg" target="_blank" title="Arne Blankerts">
				<img src="@baseUrl@/assets/images/speakers/Arne_Blankerts.jpg" alt="Arne Blankerts" class="img-responsive img-rounded">
			</a>
		</div>
	</div>
</div>
...
<div class="speaker">
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<a href="@baseUrl@/assets/images/speakers/Sebastian_Heuer.jpg" target="_blank" title="Sebastian Heuer">
				<img src="@baseUrl@/assets/images/speakers/Sebastian_Heuer.jpg" alt="Sebastian Heuer" class="img-responsive img-rounded">
			</a>
		</div>
	</div>
</div>
...
<div class="speaker">
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-8">
			...
			<p>
				<a href="@baseUrl@/de/programm.html#event-sourcing" class="text-uppercase"><b>Talk:</b> Event Sourcing: The good, the bad and the complicated</a>
			</p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
			<a href="@baseUrl@/assets/images/speakers/Marco_Pivetta.jpg" target="_blank" title="Marco Pivetta">
				<img src="@baseUrl@/assets/images/speakers/Marco_Pivetta.jpg" alt="Marco Pivetta" class="img-responsive img-rounded">
			</a>
		</div>
	</div>
</div>
...
<div class="speaker">
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-8">
			...
			<p>
				<a href="@baseUrl@/de/programm.html#postgresql" class="text-uppercase"><b>Talk:</b> PostgreSQL: Die NoSQL-Datenbank, die niemand kennt</a>
			</p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
			<a href="@baseUrl@/assets/images/speakers/Stephan_Hochdoerfer.jpg" target="_blank" title="Stephan Hochdoerfer">
				<img src="@baseUrl@/assets/images/speakers/Stephan_Hochdoerfer.jpg" alt="Stephan Hochdoerfer" class="img-responsive img-rounded">
			</a>
		</div>
	</div>
</div>
...
<div class="speaker">
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-8">
			...
			<p>
				<a href="@baseUrl@/de/programm.html#middleware-web-apis-in-php-7" class="text-uppercase"><b>Talk:</b> Middleware Web APIs in PHP 7.x</a>
			</p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
			<a href="@baseUrl@/assets/images/speakers/Jan_Burkl.jpg" target="_blank" title="Jan Burkl">
				<img src="@baseUrl@/assets/images/speakers/Jan_Burkl.jpg" alt="Jan Burkl" class="img-responsive img-rounded">
			</a>
		</div>
	</div>
</div>
...
<div class="speaker">
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-8">
			...
			<p>
				<a href="@baseUrl@/de/programm.html#prooph-micro" class="text-uppercase">
					<b>Talk:</b> prooph/micro - weniger ist mehr
				</a>
			</p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
			<a href="@baseUrl@/assets/images/speakers/Alexander_Miertsch.jpg" target="_blank" title="Alexander Miertsch">
				<img src="@baseUrl@/assets/images/speakers/Alexander_Miertsch.jpg" alt="Alexander Miertsch" class="img-responsive img-rounded">
			</a>
		</div>
	</div>
</div>
...
<div class="speaker">
	<div class="row">
		<div class="col-xs-12 col-sm-6 col-md-8">
			...
			<p>
				<a href="@baseUrl@/de/programm.html#react-php" class="text-uppercase">
					<b>Talk:</b> Pushing the limits with ReactPHP
				</a>
			</p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-4">
			<a href="@baseUrl@/assets/images/speakers/Christian_Lueck_300x300.jpg" target="_blank" title="Christian Lück">
				<img src="@baseUrl@/assets/images/speakers/Christian_Lueck_300x300.jpg" alt="Christian Lück" class="img-responsive img-rounded">
			</a>
		</div>
	</div>
</div>
