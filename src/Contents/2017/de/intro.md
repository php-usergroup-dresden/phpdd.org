## Dresdens größtes PHP Event geht in die 3. Runde
...
Wie auch bei den vergangenen zwei Events in [2015](http://phpug-dresden.org/events/2015/php-developer-day.html) und [2016](http://phpug-dresden.org/events/2016/php-developer-day.html) 
...
**<i class="fa fa-arrow-right"></i> [ZUM PROGRAMM](@baseUrl@/de/programm.html)**
| **<i class="fa fa-arrow-right"></i> [ZUR SPEAKER-ÜBERSICHT](@baseUrl@/de/speaker.html)**
...
**<i class="fa fa-arrow-right"></i> [ALLE INFOS ZU ORT UND ANREISE](@baseUrl@/de/ort-und-anreise.html)**
...
<div class="text-center">
	<a href="@baseUrl@/de/tickets-kaufen.html" title="ZU DEN TICKETS" class="blockspace btn btn-block btn-success btn-lg text-uppercase">
...
**<i class="fa fa-arrow-right"></i> [ALLE INFOS ZUR VERPFLEGUNG](@baseUrl@/de/verpflegung.html)**
...
**<i class="fa fa-arrow-right"></i> [SPONSOR WERDEN](@baseUrl@/de/sponsor-werden.html)**
