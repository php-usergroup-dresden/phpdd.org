...
set :deploy_to, '/var/www/stage.phpdd.org'
...
task :generate_static_pages do
    command 'php vendor/bin/spg.phar generate:pages -b https://stage.phpdd.org Project2018.json'
    command 'php vendor/bin/spg.phar generate:sitemap -b https://stage.phpdd.org Project2018.json'
    command 'php vendor/bin/spg.phar generate:search-index -b https://stage.phpdd.org Project2018.json'
end

desc "Check static pages"
task :check_static_pages do
    command 'php vendor/bin/spg.phar check:links -b https://stage.phpdd.org Project2018.json'
end

desc "Clear twig cache"
task :clear_twig_cache do
    command 'sudo rm -rf /var/www/stage.phpdd.org/shared/twig/*'
end
